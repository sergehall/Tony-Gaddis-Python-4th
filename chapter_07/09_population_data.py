...
def main():
    ...
    print("The average annual change in population between 1950 and 1990 is",
          format(average, ",.2f"))
    print("The greatest increase in population occured in the year of",
          annual_change.index(max(annual_change)) + 1951, "with an increase of",
          max(annual_change))
    print("The smallest increase in population occured in the year of",
          annual_change.index(min(annual_change)) + 1951, "with an increase of",
          min(annual_change))
