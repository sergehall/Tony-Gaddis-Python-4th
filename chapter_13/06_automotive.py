...
class JoeAutomotiveGUI:
    ...
    def show_total(self):
        # calculate the total
        self.total = self.oil_checked.get() \
                     + self.lube_checked.get() \
                     + self.radiator_checked.get() \
                     + self.transmission_checked.get() \
                     + self.inspection_checked.get() \
                     + self.muffler_checked.get() \
                     + self.tire_checked.get()
