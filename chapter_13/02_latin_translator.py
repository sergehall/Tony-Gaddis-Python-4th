...
class LatinTranslatorGUI:
    def __init__(self):
        ...
        self.translation_label1 = tkinter.Label(self.top_frame, bg="green",
                                                fg="white", \
                                                textvariable=self.translation1)
        self.translation_label2 = tkinter.Label(self.mid_frame, bg="green",
                                                fg="white", \
                                                textvariable=self.translation2)
        self.translation_label3 = tkinter.Label(self.bottom_frame, bg="green",
                                                fg="white", \
